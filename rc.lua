...
-- {{{ Tags
tags = {
  names   = { "terminal", "internet", "files", "graph", "music", "six", "7", "8", "nine", "10" },
  layouts = { layouts[10], layouts[10], layouts[10], layouts[10], layouts[10],
              layouts[10], layouts[10], layouts[10], layouts[10], layouts[10] } }
...
mylauncher:buttons(awful.util.table.join(
  ...
  awful.button({ modkey }, 1,
    function()
      local reboot = "zenity --question --text 'Reiniciar?' && systemctl reboot"
  ...
  awful.button({ modkey }, 3,
    function()
      local shutdown = "zenity --question --text 'Apagar?' && systemctl poweroff"
...
globalkeys = awful.util.table.join(
  ...
  awful.key({ modkey, }, "i", function() awful.util.spawn(internet) end),
  ...
  awful.key({ altkey, }, "space", function() awful.layout(layouts, 1) end),
